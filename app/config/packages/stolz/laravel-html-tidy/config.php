...
return array(
	...
	'container_open_tag' => '<div id="tidy_errors" style="position: absolute;right: 0;top: 0;z-index: 100;padding:1em;margin: 70px 1em 1em 1em;border:1px solid #DC0024;font-family: Sans-Serif;background-color:#FFE5E5;color:#DC0024"><a style="float:right;cursor:pointer;color:blue;margin:-15px" onclick="document.getElementById(\'tidy_errors\').style.display = \'none\'">&times</a>',
	...
	'ignored_errors' => array(
		...
		"/line.*proprietary attribute \"tabindex.*\n?/",
		...
		"/line.*attribute \"tabindex\" has invalid value \"-1\".*\n?/",
	),
);
